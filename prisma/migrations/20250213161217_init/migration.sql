...
CREATE TABLE `Tables` (
    ...
    `tabCreatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `Reservations` (
    ...
    `resCreatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `MenuItems` (
    ...
    `menuItemCreateAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `orderItem` (
    ...
    PRIMARY KEY (`Orders_orderID`, `MenuItems_menuItemsID`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Bill` (
    ...
    `billCreateAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `Stock_In` (
    ...
    `stockInDateTime` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `orderItem` ADD CONSTRAINT `orderItem_Orders_orderID_fkey` FOREIGN KEY (`Orders_orderID`) REFERENCES `Orders`(`orderID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `orderItem` ADD CONSTRAINT `orderItem_MenuItems_menuItemsID_fkey` FOREIGN KEY (`MenuItems_menuItemsID`) REFERENCES `MenuItems`(`menuItemsID`) ON DELETE CASCADE ON UPDATE CASCADE;
